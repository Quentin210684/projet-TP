...
<?php require_once 'controllers/addCommentModifController.php'; ?>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <?php if (count($_POST) == 0 || count($formErrors) > 0) { ?>
                        ...
                        <form action="user-modification-commentaire_<?= $comment->id ?>" method="POST">
                            ...
                            <div class="col-sm-12 mb-4 mt-4">
                                ...
                                <div class="mb-3 col-sm-11 mt-5 text-end">
                                    ...
                                    <a href="mes-commentaires" class="btn btn-outline-dark text-white border border-white" title="Retour"><i class="fas fa-reply"></i></a>
