...
<?php require_once 'controller/addListgameadminControllers.php'; ?>
                            ...
                            <?php if (count($_POST) == 0 || count($formErrors) > 0) { ?>
                                ...
                                <form action="addListgameadmin.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-8 mt-3 mb-3 mx-auto text-white">
                                        <label for="formFileSm1" class="form-label">Image</label>
                                        <input class="form-control form-control-sm" name="formFileSm1" id="formFileSm1" type="file">
                                    </div>
                                    ...
                                    <div class="col-sm-8 mt-3 mb-3 mx-auto text-white">
                                        <label for="date" class="form-label">Date sortie anticipé</label>
