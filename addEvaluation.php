                    ...
                    <?php if (count($_POST) == 0 || count($formErrors) > 0) { ?>
                        ...
                        <form action="evaluation" method="POST">
                            ...
                            <div class="stars mb-3 mt-3">
                                ...
                                <label class="rate">
                                    <input type="radio" name="rating" id="star3" value="star3">
                                    <div class="face"></div>
                                    <i class="far fa-star star three-star"></i>
                                </label>
                                <label class="rate">
                                    <input type="radio" name="rating" id="star4" value="star4">
                                    <div class="face"></div>
                                    <i class="far fa-star star four-star"></i>
                                </label>
                                <label class="rate">
                                    <input type="radio" name="rating" id="star5" value="star5">
                                    <div class="face"></div>
                            ...
                            <div class="col-sm-12 mb-4 mt-4">
                                ...
                                <div class="mb-3 col-sm-11 mt-5 text-end">
                                    <button class="btn btn-outline-dark text-white border border-white" name="send" id="send">Publiez</button>
