<?php
// Permet de contrôler la session de l'ajout des jeux, si un utilisateur autre que l'administrateur essaye de se connecter 
// il ne pourra pas y avoir accés même en passant par l'url.
...
if (count($_POST) > 0) {
    ...
    if (!empty($_POST['title'])) {
         ...
         * Ça me permet de contrôler ce qui entrera plus tard dans ma base de données
