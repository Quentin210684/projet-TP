...
//             $game->title2 = strip_tags($_POST['title2']);
//             /**
//              * strip_tags() tente de retourner la chaîne string après avoir supprimé tous les octets nuls, toutes les balises PHP et HTML du code. 
//              * Elle génère des alertes si les balises sont incomplètes ou erronées.
//              */
...
//                 $game->trailer = 'uploads/' . $_FILES['trailer']['name'];
//             } else {
...
//         if (preg_match($regex['name'], $_POST['summary'])) {
...
//              */
//         } else {
//             $formErrors['summary'] = 'Le nom d\'utilsateur est invalide. Il ne doit comporter que des lettre, des chiffres, des tirets, des espaces.';
//         }
//     } else {
//         $formErrors['summary'] = 'Votre message est vide.';
//     }
//     if (count($formErrors) == 0) {
//         var_dump($game->addGames());
//     }
// }
// var_dump($formErrors);
// var_dump($_POST);
...
$game->trailer = $_FILES['trailer']['name'];
