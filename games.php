                ...
                <div class="row">
                    <div class="col-sm mt-2 ms-2 mb-2 animate__animated animate__zoomInDown">
                        <figure class="figure border border-3 border-outset border-dark">
                            <img src="assets/img/page jeux 1logic.jpg" class="img-fluid figure-img rounded mb-0" alt="...">
                    ...
                    <div class="col-sm mt-2 ms-2 mb-2 animate__animated animate__zoomInDown">
                        <figure class="figure border border-3 border-outset border-dark">
                            <img src="assets/img/page jeux 2 dd.jpg" class=" img-fluid figure-img rounded mb-0" alt="...">
                            <div class="d-flex align-items-center colorLogo2 fw-bold">
                    ...
                    <div class="col-sm mt-2 ms-2 mb-2 animate__animated animate__zoomInDown">
                        <figure class="figure border border-3 border-outset border-dark">
                            <img src="assets/img/page jeux 3.jpg" class=" img-fluid figure-img rounded mb-0" alt="...">
                            <div class="d-flex align-items-center colorLogo2 fw-bold">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm mt-2 ms-1 mb-2 animate__animated animate__zoomInDown">
                                <figure class="figure border border-3 border-outset border-dark">
                                    <img src="assets/img/page jeux 4.jpg" class="img-fluid figure-img rounded mb-0" alt="...">
                                    <div class="d-flex align-items-center colorLogo2 fw-bold">
                            ...
                            <div class="col-sm mt-2 ms-1 mb-2 animate__animated animate__zoomInDown">
                                <figure class="figure border border-3 border-outset border-dark">
                                    <img src="assets/img/page jeux 5.jpg" class="img-fluid figure-img rounded mb-0" alt="...">
                                    <div class="d-flex align-items-center colorLogo2 fw-bold">
                            ...
                            <div class="col-sm mt-2 ms-1 mb-2 animate__animated animate__zoomInDown">
                                <figure class="figure border border-3 border-outset border-dark">
                                    <img src="assets/img/page jeux 6.jpg" class="figure-img img-fluid rounded mb-0" alt="...">
                                    <div class="d-flex align-items-center colorLogo2 fw-bold">
