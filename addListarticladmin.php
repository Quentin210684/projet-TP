...
<?php require_once 'controller/addListarticladminControllers.php'; ?>
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3 text-start">
            <h2 id="neon" class="text-start mt-3 mb-5">Ajouter un Article</h2>
            <div class="col-sm-12">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 shadow mx-auto">
                            ...
                            <?php if (count($_POST) == 0 || count($formErrors) > 0) { ?>
                                ...
                                <form action="addListarticladmin.php" method="POST" enctype="multipart/form-data">

                                    <div class="col-sm-8 mt-3 mb-3 mx-auto text-white">
                                        <label for="paper" class="form-label">Image</label>
                                        <input class="form-control form-control-sm" name="paper" id="paper" type="file">
                                    </div>
                                    ...
                                    <div class="col-sm-8 mt-3 mb-3 mx-auto text-white">
                                        ...
                                        <label for="floatingTextarea2">Corps de l'article</label>
                                        <textarea class="form-control <?= isset($formErrors['message']) ? 'is-invalid' : '' ?> " value="<?= @$_POST['message'] ?>" name="message" id="floatingTextarea2" style="height: 100px"></textarea>
                                    ...
                                    <div class="col-sm-8 mt-3 mb-3 mx-auto text-white">
                                        <label for="title" class="form-label">Nom du journal</label>
                                        <input type="text" class="form-control <?= isset($formErrors['title']) ? 'is-invalid' : '' ?> " value="<?= @$_POST['title'] ?>" id=" title" name="title">
                                    ...
                                    <div class="col-sm-8 mt-3 mb-3 mx-auto text-white">
                                        <label for="heure" class="form-label">Heure de publication</label>
                                        <input type="time" class="form-control" id=" heure" name="heure">
                                    </div>

                                    <div class="mb-3 col-sm-11 mt-4 text-center">
                                        <button type="submit" class="btn btn-outline-dark text-white border border-white" name="button" id="button">Publiez</button>
                                    </div>

                                </form>
                            <?php } else { ?>
                                <div class="text-center text-white mt-4 fs-5">
                                    <p>Bonjour, <?php echo $title . ' à bien été envoyez' ?></p>
                                </div>
