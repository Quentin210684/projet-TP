...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3 text-start">
            <h2 id="neon" class="text-start mt-3 mb-5">Mon espace personnel</h2>
            <div class="col-sm-12">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?php } else { ?>
                                <div class="text-center text-white mt-4 fs-5">
                                    <p>Bonjour, <?php echo $name . ' merci de votre inscription. Vous allez reçevoir un mail de validation' ?></p>
                                </div>
